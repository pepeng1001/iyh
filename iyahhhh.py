...
if submitted:
    with st.spinner("⏳ Menghitung kebutuhan air harian kamu..."):
        ...
        <div style='background-color:#fff8e1; padding:15px; border-left:5px solid #f4c430; border-radius:10px;'>
            <ul>
                <li>👩‍⚕ <strong>Dr. Hydrina Segar</strong>: "Minumlah air sebelum merasa haus. Haus adalah tanda tubuh sudah mulai kekurangan cairan."</li>
                <li>🧑‍⚕ <strong>Dr. Aqua Vita</strong>: "Bawalah botol air sendiri ke mana pun kamu pergi. Ini membantu kamu tetap terhidrasi sepanjang hari."</li>
                <li>👨‍⚕ <strong>Dr. Sehat Jernih</strong>: "Perhatikan warna urinmu! Jika terlalu gelap, itu tandanya kamu perlu minum lebih banyak."</li>
                <li>👩‍⚕ <strong>Dr. Minerva Airin</strong>: "Orang dengan penyakit tertentu (seperti ginjal atau jantung) harus berkonsultasi dulu sebelum menaikkan asupan cairan."</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
